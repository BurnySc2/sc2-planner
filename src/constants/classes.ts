...
const CLASSES = {
    ...
    boResourceContainer: "relative flex flex-row",
    boResourceWideContainer: "m-0 p-0",
    boResourceBorderContainer: "flex items-end m-0 p-0 border border-black overflow-hidden",
