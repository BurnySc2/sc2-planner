...
const CUSTOMACTIONS: Array<ICustomAction> = [
    ...
    {
        internal_name: "chronoboost_busy_templar_archive",
        name: "Chrono Templar Archive",
        imageSource: "btn-ability-spearofadun-chronosurge.png",
        duration: 20,
        race: "protoss",
        id: 36,
    ...
    {
        internal_name: "chronoboost_busy_dark_shrine",
        name: "Chrono Dark Shrine",
        imageSource: "btn-ability-spearofadun-chronosurge.png",
        duration: 20,
        race: "protoss",
        id: 37,
    ...
    {
        internal_name: "chronoboost_busy_robotics_bay",
        name: "Chrono Robotics Bay",
        imageSource: "btn-ability-spearofadun-chronosurge.png",
        duration: 20,
        race: "protoss",
        id: 38,
    ...
    {
        internal_name: "chronoboost_busy_fleet_beacon",
        name: "Chrono Fleet Beacon",
        imageSource: "btn-ability-spearofadun-chronosurge.png",
        duration: 20,
        race: "protoss",
        id: 39,
