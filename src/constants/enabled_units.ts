...
data.Ability.forEach((ability) => {
    ...
    if (typeof target !== "string") {
        ...
        const train: { produces: number } | undefined = target.Train
        ...
        const build = target.BuildInstant
        ...
        const trainPlace = target.TrainPlace
        ...
        const buildStructure = target.Build
        ...
        const buildGas = target.BuildOnUnit
